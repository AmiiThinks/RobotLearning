...
class ObservationManager:
    ...
    #Example format of dynamixel servos
    """
    motor_states:
  -
    ...
    def publishObservation(self):
        ...
        #TODO - Create and publish the actual message as per above

        threading.Timer(self.publishingFrequency, self.publishObservation).start()

    def setupSensorListeners(self):
        #Set up all of the subscribers to listen to the sensor data
